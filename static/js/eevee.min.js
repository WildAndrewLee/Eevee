...
function NumberField(a) {
    ...
    this.placeholder = a.placeholder || this.min, this.addValidator(function(a) {
        ...
        a > this.max ? $(this.field).val(this.max) : a < this.min && $(this.field).val(this.min);
    });
}
...
FieldTemplate.prototype.addValidator = function(a) {
    ...
    for (var a = 0; a < this._validators.length; a++) if (!this._validators[a].call(this, this.value)) return !1;
    return !0;
